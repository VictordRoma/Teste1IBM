            ...
            <form method="post" action="controller/ControllerCadastro.php?funcao=cadastro" id="form" name="form">  
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="txt" class="form-control" require id="TxtNome" name="TxtNome">
                    </div>
                    <div class="col-md-6">
                        <label for="inputCategoria4" class="form-label">Categoria</label>
                        <input type="txt" class="form-control" require id="TxtCat" name="TxtCat">
                    </div>
                    <div class="col-md-6">
                        <label for="inputPreco4" class="form-label">Preço</label>
                        <input type="txt" class="form-control" id="TxtPreco" name="TxtPreco">
                    </div>
                    <div class="col-12">
